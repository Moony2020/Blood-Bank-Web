...
try{
    ...
    ResultSet rs=statement.executeQuery("select *from donor where id='"+id+"'");
    while(rs.next()){
%>
 <div class="container">
...
<h2 value="<%=rs.getString(3)%>" emergencydonor="emergencydonor">Emergency Donor</h2>
<select name= "emergencydonor">
<option value = "Yes">Yes</option>
<option value = "No">No</option>
</select>
 <h2 value="<%=rs.getString(4)%>" age="age">Age</h2>
<select name= "age">
...
<option value ="60">60</option>
 ...
 <h2 value="<%=rs.getString(7)%>" bloodgroup="bloodgroup">Blood Group</h2>
...
<option value = "AB-">AB-</option>
 ...
 <h2 value="<%=rs.getString(9)%>" donationlocation="donationlocation">Donation Location</h2>
...
<h2>Donation Time</h2>
 <input type= "datetime-local" value="<%=rs.getString(10)%>" name="donationtime">
 <br>
